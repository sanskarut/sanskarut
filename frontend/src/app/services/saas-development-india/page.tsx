...
import { ArrowRight, CheckCircle2, ShieldCheck, Zap, Layers, MapPin, Sparkles, Terminal } from "lucide-react"
import { Navbar } from "@/components/navbar"
import { Footer } from "@/components/footer"
import { Button } from "@/components/ui/button"
import Link from "next/link"

export default function IndiaSaasServicePage() {
  ...
  const stats = [
    { num: "42%+", label: "Server Cost Reductions" },
    { num: "10k/sec", label: "Concurrent Scale Delivered" },
    { num: "100%", label: "IP Protection Compliant" },
  ]

  const features = [
    {
      title: "Scalable SaaS Architectures",
      desc: "Engineering decoupled pipelines and robust multi-tenant architectures designed to handle millions of requests with ease.",
    },
    {
      title: "Cost-Optimized Cloud Models",
      desc: "Restructuring database layers, microservices, and static CDN networks to deliver high speeds while reducing cloud bills by up to 50%.",
    },
    {
      title: "Absolute Intellectual Property Safety",
      desc: "All client codebases remain completely private and secured under clear corporate NDA compliance, strict security guidelines, and transparent repositories.",
    },
  ]
        ...
        <section className="py-20 lg:py-28 relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              >
                We construct production-grade SaaS ecosystems and cloud gateways mapped to yield concrete business ROI, accelerate development roadmaps, and scale alongside enterprise transaction volumes.
              </motion.p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              ...
              <h3 className="text-3xl sm:text-4xl font-heading font-black text-[#0b192c] dark:text-white leading-tight">
                Architecting Cloud Architectures Engineered for Continuous Scale
              </h3>
              ...
              <p className="text-sm sm:text-base font-medium text-slate-500 dark:text-slate-450 leading-relaxed pt-2">
                We handle the heavy lifting of cloud database design, message routing, security verification, and load balancing so your team can focus exclusively on strategic customer acquisition and core business scaling.
              </p>
            </div>
        ...
        <section className="py-24 bg-[#0b192c] text-white relative">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-6">
            ...
            <h3 className="text-3xl sm:text-4xl font-heading font-black">
              Ready to Formulate Your SaaS Blueprint?
            </h3>
            <p className="text-sm sm:text-base text-slate-350 max-w-xl mx-auto leading-relaxed">
              Partner directly with senior system engineers who understand product market growth cycles, and construct secure platforms mapped for continuous operations.
            </p>
            <div className="pt-4">
              <Link href="/#contact">
