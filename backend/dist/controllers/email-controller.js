...
function renderEmailTemplate(title, bodyContent, ctaText, ctaUrl) {
...
export async function getEmailLogsController(req, res, next) {
    try {
...
export async function getDeveloperTemplatesController(req, res, next) {
    try {
